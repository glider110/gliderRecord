...
![](../../assets/image/record/sliver_record/c++/image-20201011161753895.png)

如果控制台没报错，全程没有标红err，编译过了还报错，说明是CMakeLists.txt包含定义//==一个月后又犯这问题==

![image-20201119091456901](../../assets/image/record/sliver_record/c++/image-20201119091456901.png)
...
![image-20201020154924643](../../assets/image/record/sliver_record/c++/image-20201020154924643.png)
